...
class MagicBand(cli.CommandLineInterface):
    ...
    def playStartupSequence(self):
        ...
        self.playSound("/home/pi/startup.wav")

        self.do_lights_on_fade(COLORS['rainbow'])
    ...
    def on_rdwr_connect(self, tag):
        ...
        if bandid == '041f3baa826880' :
            if config['scanned']['0424454a1c6480'] == False and config['scanned']['04247dba826880'] == False and config['scanned']['041a544a796580'] == False:
                config['scanned']['041f3baa826880'] = True
                config.write()
                self.playSequence(config['sequences']['summer'])
            else:
                config['scanned']['041f3baa826880'] = False
                config['scanned']['04247dba826880'] = False
                config['scanned']['0424454a1c6480'] = False
                config['scanned']['041a544a796580'] = False
                config.write()
                self.playError()

        elif bandid == '04247dba826880' :
            if config['scanned']['041f3baa826880'] == True and config['scanned']['0424454a1c6480'] == False and config['scanned']['041a544a796580'] == False:
                config['scanned']['04247dba826880'] = True
                config.write()
                self.playSequence(config['sequences']['avalee'])
            else:
                config['scanned']['041f3baa826880'] = False
                config['scanned']['04247dba826880'] = False
                config['scanned']['0424454a1c6480'] = False
        ...
        elif bandid == '0424454a1c6480' :
            if config['scanned']['041f3baa826880'] == True and config['scanned']['04247dba826880'] == True and config['scanned']['041a544a796580'] == False:
                config['scanned']['0424454a1c6480'] = True
                config.write()
                self.playSequence(config['sequences']['john'])
            else:
                config['scanned']['041f3baa826880'] = False
                config['scanned']['04247dba826880'] = False
                config['scanned']['0424454a1c6480'] = False
        ...
        elif bandid == '041a544a796580' :
            if config['scanned']['041f3baa826880'] == True and config['scanned']['04247dba826880'] == True and config['scanned']['0424454a1c6480'] == True:
    ...
    def playSequence(self, sequence):
        ...
        successSoundFound = self.loadSound(sequence.get('success_sound'))
        ...
        if successSoundFound == True:
            self.playSound(sequence.get('success_sound'))
    ...
    def playOpenDoor(self, sequence):
        ringSoundFound = self.loadSound(sequence.get('spin_sound'))
        successSoundFound = self.loadSound(sequence.get('success_sound'))
    ...
    def playError(self):
        errorSounds = glob.glob("/home/pi/*.mp3")
        randomSound = random.choice(errorSounds)

        self.playSound("/home/pi/chime.wav")
        self.do_lights_circle(COLORS['red'], reverse_circle)
        time.sleep(1)

        self.playSound(randomSound)

        self.do_lights_on_fade(COLORS['red'])
        while pygame.mixer.music.get_busy() == True:
            time.sleep(1)
        else:
            self.do_lights_off_fade()
    ...
    def on_card_startup(self, target):
        ...
        print("Listening for Magicbands")
